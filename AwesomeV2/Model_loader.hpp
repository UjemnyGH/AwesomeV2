...
struct BufferMeshData
{
    ...
    {
        this->vertices.clear();
        std::move(b_data.vertices.begin(), b_data.vertices.end(), std::back_inserter(this->vertices));

        this->textureCoordinates.clear();
        std::move(b_data.textureCoordinates.begin(), b_data.textureCoordinates.end(), std::back_inserter(this->textureCoordinates));

        this->normals.clear();
        std::move(b_data.normals.begin(), b_data.normals.end(), std::back_inserter(this->normals));
